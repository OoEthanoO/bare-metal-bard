...
#include "../kernels.h"
#if BMB_TF32
// The register mapping, the lane-major layout it forces, and the XOR swizzle
// that makes the store side survive it all live in this header now, because
// kernel 11 reuses them unchanged and a second copy would drift.
